              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                ...
                <nav class="flex flex-1 flex-col">
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    ...
                    <li>
                      <div class="text-xs/6 font-semibold text-gray-400">Career Paths</div>
                      <ul role="list" class="-mx-2 mt-2 space-y-1">
                        <li v-for="path in careerPaths" :key="path.name">
                          <a :href="path.href" :class="[path.current ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600', 'group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold']">
                            <span :class="[path.current ? 'border-indigo-600 text-indigo-600' : 'border-gray-200 text-gray-400 group-hover:border-indigo-600 group-hover:text-indigo-600', 'flex size-6 shrink-0 items-center justify-center rounded-lg border bg-white text-[0.625rem] font-medium']">{{ path.initial }}</span>
                            <span class="truncate">{{ path.name }}</span>
                          </a>
                        </li>
                      </ul>
                    </li>
...
const careerPaths = [
  { id: 1, name: 'Software Development', href: '#', initial: 'SD', current: true },
  { id: 2, name: 'Data Science', href: '#', initial: 'DS', current: false },
  { id: 3, name: 'Product Management', href: '#', initial: 'PM', current: false },
]
